...
export class BloggerController {
  ...
  //{blogId}/posts/{postId} Update existing post by id with InputModel
  //{blogId}/posts/{postId} Delete post specified by id
  ...
  async getAllBlogsByOwner(
    ...
    return this.blogQueryRepository.getAllBlogsByOwnerId(
      blogPaginationQueryDto,
      user.id,
    );
  }
}
